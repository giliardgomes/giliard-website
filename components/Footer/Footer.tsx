        ...
        <div className={styles.top}>
          ...
          <nav className={styles.footerSection} aria-label="Social media">
            ...
            <ul className={`${styles.linksFooter} ${styles.socialLinks}`}>
                <li>
                  <a title='LinkedIn' href='https://linkedin.com/in/giliardgomes' target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label='LinkedIn'>
                ...
                <li>
                  <a title='Figma' href='https://figma.com/@giliard' target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label='Figma'>
                ...
                <li>
                  <a title='GitHub' href='https://github.com/giliardgomes' target="_blank" rel="noopener noreferrer" className={styles.socialLink} aria-label='GitHub'>
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
